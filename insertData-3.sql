...
--- Đã xong
-----8. Phim------ P00001
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values (N'Gia đình đức hạnh',null,'90',N'Thái Lan','2020-12-22',18,'TLP001',N'Noi dung1');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Mắt Biếc',null,'97',N'Việt Nam','2020-12-22',18,'TLP003',N'Kể về câu chuyện giữa Ngạn và Hà Lan');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Nhà có khách',null,'90',N'Việt Nam','2021-12-22',18,'TLP001',N'Noi dung 2');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Em chưa 18',null,'90',N'Việt Nam','2019-12-20',18,'TLP003',N'Noi dung1');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Bố già',null,'90',N'Việt Nam','2020-12-22',18,'TLP001',N'Noi dung1');

insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Bẫy ngọt ngào',null,'90',N'Thái Lan','2020-09-22',18,'TLP003',N'Noi dung1');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Em và Trịnh',null,'90',N'Việt Nam','2020-09-22',18,'TLP003',N'Kí ức Trịnh Công Sơn');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Chung Cực Bút Ký',null,'95',N'Trung Quốc','2020-09-22',13,'TLP005',N'Đạo mộ bút ký - Chung cực bút ký');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Sa Hải',null,'90',N'Trung Quốc','2020-09-22',18,'TLP005',N'Đạo mộ bút ký - Sa Hải');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Nộ Hải Tiềm Sa',null,'90',N'Việt Nam','2020-09-22',18,'TLP003',N'Hành trình khám phá cổ mộ');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Vân Đỉnh Thiên Cung',null,'90',N'Trung Quốc','2020-09-22',18,'TLP003',N'Hành trình khám phá cổ mộ');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Lão Cữu Môn',null,'90',N'Trung Quốc','2020-09-22',18,'TLP003',N'Hành trình khám phá cổ mộ');

--
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'30 Chưa Phải Là Tết',null,'137',N'Việt Nam','2022-01-22',13,'TLP004',N'Cuộc về Tết bất ngờ');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Tàng Hải Hoa',null,'120',N'Trung Quốc','2021-12-22',16,'TLP005',N'Đạo mộ cùng Ngô Tà');
insert into PHIM (TenPhim,AnhPhim,ThoiLuong,QuocGia,NamSanXuat,DoTuoiXem,MaTheLoai ,NoiDung)
values(N'Đại Hồng Thủy',null,'125',N'Anh','2020-09-22',16,'TLP004',N'Đại hồng thủy trong lịch sử nhân loại');
...
insert into CHI_TIET_PHIEU_PHIM(MaPhieu,MaPhim,DonViTinh,SoLuong) values('PH0009','P00003',N'Đĩa','1');s